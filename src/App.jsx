...
const SafePass = () => {
  return (
    <>
      ...
      {/* Home Section */}
      <section id="home" className="page-section"></section>

      {/* About Us Section */}
      <section id="AboutUS" className="page-section">
        <div className="aboutUsPage">
          <div className="left-image">
            <img src="images/About.svg" alt="Visitor" />
          </div>
      ...
      <section id="SafePassWorks" className="page-section">
        ...
        <div className="works-card-container">
          <div className="works-card">
            ...
            <p>
              The visitor enters their basic details including name, phone number,
          ...
          <div className="works-card">
            ...
            <p>
              SafePass instantly generates a secure digital QR code for smooth
              entry processing.
            </p>
          </div>
          ...
          <div className="works-card">
            ...
            <p>
              Security scans the QR code for quick and contactless verification
              upon arrival.
            </p>
          </div>
          ...
          <div className="works-card">
            ...
            <h3>Track & Monitor</h3>
            <p>
              All check-in and check-out activity is recorded on the dashboard
      ...
      <section id="KeyFeatures" className="page-section">
        ...
        <div className="f-container">
          <div className="f-card">
            ...
            <p>
              Easily register visitors with essential details, reducing paperwork
          ...
          <div className="f-card">
            ...
            <p>
              Generate unique QR codes for contactless and secure visitor check-ins.
            </p>
          </div>
          ...
          <div className="f-card">
            ...
            <p>
              Monitor live visitor status and access points in a centralized dashboard.
            </p>
          </div>
          ...
          <div className="f-card">
            ...
            <p>
              Maintain accurate records of all visitor movements for accountability
              and safety.
            </p>
          </div>
          ...
          <div className="f-card">
            <h3>Reports</h3>
            <p>
              Generate detailed visitor and access reports for insights and better
              decision-making.
            </p>
          </div>
        </div>
      ...
      <section id="ContactUs" className="page-section">
        ...
        <div className="contact-content">
          <p>
            <strong>Contact:</strong> safepass.support@gmail.com | +92 300 1234567
          </p>

          <p>
            <strong>Office:</strong> SafePass Security Center, Karachi, Pakistan
          </p>
